...
$router->add("POST","/api/addmove",     "api.php", "add_move",       'api', array("gameid" => "int", "movenum" => "int", "position" => "str", "side" => "int", "value" => "float", "outcome" => "int", "timetaken" => "float", "work" => "int", "nodes" => "int", "comment" => "str"));
