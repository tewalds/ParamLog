...
$router->add("GET", "/games",          "games.php", "getgames",    'user', array("players" => "array", "baselines" => "array", "times" => "array", "sizes" => "array", 'page' => 'int'));
$router->add("GET", "/games/movelist", "games.php", "game_move_list",'user', array("players" => "array", "baselines" => "array", "times" => "array", "sizes" => "array", 'page' => 'int'));
...
$router->add("POST","/api/savegame",    "api.php", "save_game",      'api', array("id" => "int", "player1" => "int", "player2" => "int", "size" => "int", "time" => "int", "lookup" => "str", "outcome1" => "int", "outcome2" => "int", "outcomeref" => "int", "timestamp" => "int", "version1" => "string", "version2" => "string", "host" => "str", "saveresult" => "bool", "jsonmoves" => "str"));
...
$router->add("POST","/api/addmoves",    "api.php", "add_moves",      'api', array("gameid" => "int", "jsonmoves" => "str"));
