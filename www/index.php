...
$router->add("POST","/api/savegame",    "api.php", "save_game",      'api', array("id" => "int", "player1" => "int", "player2" => "int", "size" => "int", "time" => "int", "lookup" => "str", "outcome1" => "int", "outcome2" => "int", "outcomeref" => "int", "version1" => "string", "version2" => "string", "host" => "str", "saveresult" => "bool", "jsonmoves" => "str"));
